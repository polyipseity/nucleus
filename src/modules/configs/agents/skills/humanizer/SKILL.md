...
1. **Identify patterns** using the list below
2. **Rewrite only the affected parts** with clearer, more natural phrasing
3. **Preserve meaning and factual content**
4. **Match the intended tone** (formal, casual, technical, etc.)
5. **Keep a human voice** so the result does not read as sterile
