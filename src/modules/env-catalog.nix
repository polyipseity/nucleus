# Static secret-to-env-var catalog.  Every entry maps a SOPS secret name
# (from src/secrets/system.yml) to the environment variable it should be
# exported as.  Add new secrets here when they are added to system.yml.
{
  keys = [
    {
