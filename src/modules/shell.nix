  ...
  programs.zsh = {
    ...
    initContent = ''
      ...
      _prek_repo_hooks_installed() {
        ...
        [[ -f "$hook_dir/commit-msg" ]] || return 1
        [[ -f "$hook_dir/pre-commit" ]] || return 1
        [[ -f "$hook_dir/pre-push" ]] || return 1
        grep -qF '# File generated by prek' "$hook_dir/commit-msg" || return 1
        grep -qF '# File generated by prek' "$hook_dir/pre-commit" || return 1
        grep -qF '# File generated by prek' "$hook_dir/pre-push" || return 1
      }
