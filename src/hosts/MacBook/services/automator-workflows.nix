...
#     render). Generated once via src/hosts/MacBook/scripts/generate-automator-
#     thumbnails.swift and committed as a static asset. Regenerate when
#     changing the symbol name for a workflow.
