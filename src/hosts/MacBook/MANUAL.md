...
- Apple Command Line Tools (CLT) are not required. nixpkgs provides the
  compiler (`llvmPackages.clang`), SDK (`apple-sdk` via `DEVELOPER_DIR`), and
  linker tools (`darwin.cctools`) declaratively.
