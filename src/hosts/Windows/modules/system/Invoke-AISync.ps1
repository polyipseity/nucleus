...
function Invoke-AISync {
  ...
  # undoc-supp: probe — services.json may not exist; $null-conditional access handles absence gracefully.
  ...
  # undoc-supp: probe — ollama may not be installed; $null check handles absence.
