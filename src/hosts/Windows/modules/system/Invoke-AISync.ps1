...
function Invoke-AISync {
  ...
  # WHY: probe — services.json may not exist; $null-conditional access handles absence gracefully.
  ...
  # WHY: probe — ollama may not be installed; $null check handles absence.
