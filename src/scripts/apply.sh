...
ln -sf "$REPO_ROOT/src/modules/configs/litellm/litellm-config.yml" "$NUCLEUS_USER_ROOT/litellm-config.yml"
...
ln -sf "$REPO_ROOT/src/modules/configs/litellm/litellm-cooldown-400.py" "$NUCLEUS_USER_ROOT/litellm-cooldown-400.py"
