...
# -----------------------------------------------------------------------
# Nucleus-command completions: generated by src/scripts/completions/gen-completions.sh,
# freshness enforced by check step 10-completions-fresh. Copied directly
# from the tree (no install-time generation).
# -----------------------------------------------------------------------
