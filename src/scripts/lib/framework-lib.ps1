...
function Preflight-Check {
  Assert-ToolAvailable -Name 'yamllint' -Type 'Tool' -InstallCommand "pip install yamllint"
  ...
  Assert-ToolAvailable -Name 'check-jsonschema' -Type 'Tool' -InstallCommand "pip install check-jsonschema"
}
