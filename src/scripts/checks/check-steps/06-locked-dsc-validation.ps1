Register-Step -Id "locked-dsc-validation" -Number 6 -Name "Locked DSC validation" -Action {
  param($RepoRoot)
  ...
  $dscSystemFiles = Get-ChildItem (Join-Path $dscSystemDir '*.dsc.yml') | Where-Object { $_.Name -ne 'packages.dsc.yml' } | Sort-Object Name  # ref: allow-and-deny-lists.instructions.md#A3 -- packages DSC is generated from lockfile, not manually authored
