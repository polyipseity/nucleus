...
register_step "activation-token-placeholder" 16 "Activation script token placeholder in comment check" run_16_activation_token_placeholder

run_16_activation_token_placeholder() {
