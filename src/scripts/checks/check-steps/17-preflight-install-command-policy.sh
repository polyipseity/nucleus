...
register_step "preflight-install-command-policy" 17 "Preflight InstallCommand policy" run_17_preflight_install_command_policy

run_17_preflight_install_command_policy() {
