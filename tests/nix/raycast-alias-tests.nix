...
assert containsRegex "Clipboard Manager" macbookDefaultsText;
assert containsRegex "Open Clipboard History" macbookDefaultsText;
assert containsRegex "Open Clipboard Manager" macbookDefaultsText;
