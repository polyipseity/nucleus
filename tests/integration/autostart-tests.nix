...
assert containsRegex "macos_launchagent_ensure" autostartShText;
assert containsRegex "macos_remove_app_launchagent" autostartShText;
assert containsRegex "LaunchAgents" autostartShText;
