...
let
  ...
  svcRegistryShText = builtins.readFile ../../src/scripts/checks/check-steps/09-service-registry.sh;
  svcRegistryPs1Text = builtins.readFile ../../src/scripts/checks/check-steps/09-service-registry.ps1;
