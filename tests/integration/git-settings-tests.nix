...
assert containsRegex "fetch\.pruneTags = false" posixGitText;
assert containsRegex "pull\.ff = true" posixGitText;
assert containsRegex "pull\.rebase = false" posixGitText;
