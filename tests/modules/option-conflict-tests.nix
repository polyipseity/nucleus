# tests/modules/option-conflict-tests.nix — Detect module option conflicts across hosts.
#
...
#
# Run with: nix-instantiate --eval tests/modules/option-conflict-tests.nix
