...
function Test-ScheduledTask {
  ...
  try {
    ...
    Stop-ScheduledTask -TaskPath $taskParent -TaskName $taskName -ErrorAction SilentlyContinue  # undoc-supp: best-effort stop before restart — task may not be running
